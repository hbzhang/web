...
bootcards._setOrientation = function(init) {
    ...
    if (isPortrait) {
        ...
        if (!bootcards.listOffcanvasToggle) {
            //form the list title & toggle elements

             //form the button that shows/hides the list
            ...
            //form the title element of the list offcanvas
            bootcards.listTitleEl = $("<div class='offcanvas-list offcanvas-list-title'>"  +
               "<span>" + bootcards.listTitle + "</span></div>");

            //form the title element for the menu offcanvas, insert it before the menu offcanvas
