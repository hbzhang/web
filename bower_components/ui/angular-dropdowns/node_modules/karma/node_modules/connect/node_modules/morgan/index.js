...
exports.format('combined', ':remote-addr - :remote-users [:date] ":method :url HTTP/:http-version" :status :res[content-length] ":referrer" ":users-agent"')

/**
 * Apache common log format.
 */

exports.format('common', ':remote-addr - :remote-users [:date] ":method :url HTTP/:http-version" :status :res[content-length]')

/**
 * Default format.
 */

exports.format('default', ':remote-addr - :remote-users [:date] ":method :url HTTP/:http-version" :status :res[content-length] ":referrer" ":users-agent"');
...
exports.format('short', ':remote-addr :remote-users :method :url HTTP/:http-version :status :res[content-length] - :response-time ms');
...
exports.token('remote-users', function (req) {
  var creds = auth(req)
...
exports.token('users-agent', function(req){
  return req.headers['users-agent'];
});
