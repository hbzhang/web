...
/**
 * The representation of a parsed users agent.
 *
 * @constructor
 ...
 * @param {String} source The actual users agent string
 * @api public
 */
...
/**
 * Parses the users agent string with the generated parsers from the
 * ua-parser project on google code.
 *
 * @param {String} userAgent The users agent string
 ...
 * parsed users agent string instead, in memory.
 *
