        ...
        coffee: {
            compile: {
                ...
                files: {
                    ...
                    'dist/pushmenu.js': 'src/scripts/**/*.coffee',
                    'dist/demo.js': 'demo/demo.coffee'
                }
            }
        },
        recess: {
            dist: {
                ...
                files: {
                    ...
                    "dist/pushmenu.css": ["src/styles/pushmenu.less"],
                    "dist/site.css": ["demo/site.less"]
                }
            }
        },
        copy: {
            demo: {
                files: [
                    ...
                    { expand: true, flatten: true, src: ['src/partials/**'], dest: 'dist/partials', filter: 'isFile' }
