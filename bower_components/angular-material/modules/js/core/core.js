...
function MdCoreInitialize() {
  ...
  // By default, Hammer disables users selection on desktop if swipe is enabled.
  // We don't want this, so we make sure Hammer doesn't set a users-select: none.
  ...
  function attachDragBehavior(scope, element, options) {
    ...
    function startDrag(ev) {
      ...
      element.one('$md.dragstart', function(ev) {
        // Allow users to cancel by preventing default
