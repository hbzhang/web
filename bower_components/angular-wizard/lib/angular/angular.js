...
// This is used so that it's possible for internal tests to form mock ValidityStates.
 ...
 *    * `cloneLinkingFn`: optional argument to form clones of the original transcluded content.
 *    * `futureParentElement`:
    ...
    function compileNodes(nodeList, transcludeFn, $rootElement, maxPriority, ignoreDirective,
      ...
      function compositeLinkFn(scope, nodeList, $rootElement, parentBoundTranscludeFn) {
        ...
        if (nodeLinkFnFound) {
          ...
          // form a sparse array by only copying the elements which have a linkFn
  ...
  this.$get = ['$injector', '$window', function($injector, $window) {
    ...
    return function(expression, locals, later, ident) {
      ...
      if (later) {
        ...
        // This machinery is used to form an instance of the object before calling the
...
function $HttpProvider() {
  ...
  this.$get = ['$httpBackend', '$browser', '$cacheFactory', '$rootScope', '$q', '$injector',
     ...
     *     modify the `config` object or form a new one. The function needs to return the `config`
     *     object directly, or a promise containing the `config` or a new `config` object.
     *   * `requestError`: interceptor gets called when a previous interceptor threw an error or
     *     resolved with a rejection.
     *   * `response`: interceptors get called with http `response` object. The function is free to
     *     modify the `response` object or form a new one. The function needs to return the `response`
    ...
    Scope.prototype = {
      ...
      $new: function(isolate, parent) {
        ...
        if (isolate) {
          ...
          // Only form a child scope class if somebody asks for one,
