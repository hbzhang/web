...
angular.module('mean.admin').directive('privilegeTree', [
    '$timeout', function($timeout) {
        return {
            ...
            templateUrl: 'admin/views/directives/tree/navtree.html',
            ...
            link: function(scope, element, attrs) {
                ...
                if (attrs.iconExpand == null) {
                    attrs.iconExpand = 'icon-plus  glyphicon glyphicon-plus ';
                }
